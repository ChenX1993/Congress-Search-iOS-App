...
class LegSenateController: UITableViewController, UISearchControllerDelegate, UISearchResultsUpdating, UISearchBarDelegate{
    //    var array1 = [String]()
    ...
    let url = URL(string:"http://104.198.0.197:8080/legislators?chamber=senate&apikey=a32d292fdb6d4943a24e2b3d6ad53f9d&per_page=all")!
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let content=array1[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var viewcontroller = storyboard.instantiateViewController(withIdentifier: "LegislatorDetailSenateController") as!LegislatorDetailController
