...
class BillController1: UITableViewController, UISearchControllerDelegate, UISearchResultsUpdating, UISearchBarDelegate {
    var array = [JSON]()
    var array1 = [JSON]()
    var searchButton = UIBarButtonItem()
    var stopButton = UIBarButtonItem()
    let url = URL(string:"http://104.198.0.197:8080/bills?history.active=false&last_version.urls.pdf__exists=true&apikey=a32d292fdb6d4943a24e2b3d6ad53f9d&per_page=50")!
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell" , for: indexPath) as! BillCell
        ...
        override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            var viewcontroller = storyboard.instantiateViewController(withIdentifier: "BillDetailNewController") as!BillDetailNewController
