...
class LegHouseController: UITableViewController, UISearchControllerDelegate, UISearchResultsUpdating, UISearchBarDelegate {
//    var array1 = [String]()
//    var dic = [String : Array<JSON>]()
    ...
    let url = URL(string:"http://104.198.0.197:8080/legislators?chamber=house&apikey=a32d292fdb6d4943a24e2b3d6ad53f9d&per_page=all")!
...
//        }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var viewcontroller = storyboard.instantiateViewController(withIdentifier: "LegislatorDetailHouseController") as!LegislatorDetailController
