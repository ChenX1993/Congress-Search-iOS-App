//
//  ComDetailTableController.swift
//  homework9
//
...
class ComDetailTableController: UITableViewController {
    var json: JSON = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(indexPath.row == 0){
            ...
            cell.detailTextLabel?.text = "      "+json["committee_id"].stringValue
        }
        if(indexPath.row == 1){
            cell.textLabel?.text = "Parent ID "
            if let parent = json["parent_committee_id"].string{
        ...
        if(indexPath.row == 2){
            ...
            if let chamber = json["chamber"].string {
                cell.detailTextLabel?.text = "      "+chamber
            }
            else{
                cell.detailTextLabel?.text = "      "+"N.A."
            }
