...
class ComHouseController: UITableViewController, UISearchControllerDelegate, UISearchResultsUpdating, UISearchBarDelegate{
    var array = [JSON]()
    var array1 = [JSON]()
    var searchButton = UIBarButtonItem()
    var stopButton = UIBarButtonItem()
    let url = URL(string:"http://104.198.0.197:8080/committees?chamber=house&apikey=a32d292fdb6d4943a24e2b3d6ad53f9d&per_page=all")!
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var viewcontroller = storyboard.instantiateViewController(withIdentifier: "ComHouseDetailController") as!ComHouseDetailController
